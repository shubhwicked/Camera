...
public class FileUtil {
    ...
    public static String packageFilesDirectoryVideo = null;
    public static String storagePath = null;
    public static String storagePathVideo = null;
    private static String mDefaultFolder = "Selfie";
    private static String mDefaultFolderVideo = "SelfieVideo";
  ...
  public static String getPathVideo() {
    ...
    public static String getPathVideo(Context context) {

        if(storagePathVideo == null) {
            storagePathVideo = externalStorageDirectory.getAbsolutePath() + "/" + mDefaultFolderVideo;
            File file = new File(storagePathVideo);
            if(!file.exists()) {
                if(!file.mkdirs()) {
                    storagePathVideo = getPathInPackageVideo(context, true);
                }
            }
        }

        return storagePathVideo;
    }
    ...
    public static String getPathInPackageVideo(Context context, boolean grantPermissions) {

        if(context == null || packageFilesDirectoryVideo != null)
            return packageFilesDirectoryVideo;

        //手机不存在sdcard, 需要使用 data/data/name.of.package/files 目录
        String path = context.getFilesDir() + "/" + mDefaultFolderVideo;
        File file = new File(path);
        ...
        packageFilesDirectoryVideo = path;
        return packageFilesDirectoryVideo;
    }
