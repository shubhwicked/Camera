...
public class CameraRecordGLSurfaceView extends CameraGLSurfaceView {
    ...
    public void startRecording(final String filename) {
        startRecording(filename,true, null);
    }

    public void startRecording(final String filename, final boolean isSoundRecord, final StartRecordingCallback recordingCallback) {
        ...
        queueEvent(new Runnable() {
            ...
            public void run() {
                ...
                synchronized (mRecordStateLock) {
                    mShouldRecord = true;
                    mAudioRecordRunnable = new AudioRecordRunnable(recordingCallback,isSoundRecord);
    ...
    class AudioRecordRunnable implements Runnable {
        ...
        private AudioRecordRunnable(StartRecordingCallback callback,boolean isSoundRecord) {
